...
namespace PcKeyboardHook
{
    public class KeyboardHook
    {
        ...
        private int KeyboardHookProc(int nCode, IntPtr wParam, IntPtr lParam)
        {
            ...
            if (
           ((int)m.vkCode == 91)/* Left Windows key */ || ((int)m.vkCode == 92) /* Right Windows key */ ||

           /*两个组合键 Tab + Alt */ ((m.vkCode == VK_TAB) && ((m.flags & LLKHF_ALTDOWN) != 0)) ||

           ((m.vkCode == VK_ESCAPE) && ((m.flags & LLKHF_ALTDOWN)/* escape + 空格 */ != 0)) ||
           ((m.vkCode == VK_F4) && ((m.flags & LLKHF_ALTDOWN) != 0) /* alt + F4 */) ||

           //用于三个组合键
           (m.vkCode == VK_ESCAPE) && ((GetKeyState(VK_LCONTROL) & 0x8000) != 0) ||
           ((int)m.vkCode >= 65 && (int)m.vkCode <= 89 && ((GetKeyState(0x12) & 0x8000) != 0)) ||
           ...
           (m.vkCode == VK_ESCAPE) && ((GetKeyState(VK_RCONTROL) & 0x8000) != 0)
            ...
            if (
                (m.vkCode == VK_ESCAPE) && (GetKeyState(VK_LCONTROL) & 0x8000) != 0 &&
                (m.vkCode == VK_F5) && (m.flags & LLKHF_ALTDOWN) != 0 /* alt + F5 */
              )
            {
                //return CallNextHookEx(hKeyboardHook, nCode, wParam, lParam);
                Console.WriteLine("Ctrl + Alt + F5");
            }
